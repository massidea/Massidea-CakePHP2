...
// 				'UserRole.name' => 'Admin',
	...
	public function getRecentGroups($offset)
	{
		// $this->params["pass"] looks like this:
		//     Array (
		//         [0] => offset
		//         [1] => 3
		//     )
		//
		// NOTE: Offset is a multiple of ten.
		//       That many elements are skipped.
		$offset = $this->params["pass"][1] * 10;
		...
		// debug($recentGroups) will not work,
		// but var_dump($recentGroups) will.
		$this->set('recentGroups', $recentGroups);
		// Use basic element for rendering.
		$this->render('/Groups/recent_group', 'ajax');
	}
}
