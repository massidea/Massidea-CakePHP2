...
<?php if($content_type === 'challenge'): $body = $challenge; ?>
	...
	<h2 class="light-gray border-problem"><?php echo __('Share your challenge') ?></h2>
	<p><?php echo __('Challenge is personal, business or social related problem, need, situation or observation. It describes the current status of affairs and recognizes the need to resolve the matter.') ?> </p>
	<p><?php echo __('Write to a person who is not familiar with the topic.') ?></p>
	<p><?php echo __('Keep your focus on challenge and not related solutions or visions. You can publish those one a separate document and link them later on to this challenge.') ?></p>
...
<div id="content_title" class="row">
	<div class="field-label">
		<label for="NodeTitle"><?php echo __('Header') ?></label>
		<small class="right"><?php echo __('(Explain in one sentence the whole story)') ?></small>
	</div>
	<div class="field">
	<?php echo $this->Form->input('title', array('error' 	=> array('wrap' => 'div', 'class' => 'error', true))); ?>
	</div>
	<div class="limit bad"><?php echo __('required') ?></div>
</div>
<div class="clear"></div>

<div id="content_lead" class="row">
	<div class="field-label">
		<label for="NodeLead"><?php echo __('Lead chapter') ?></label>
		<small class="right"><?php  echo __('(This text is shown in search result lists)') ?></small>
	</div>
	<div class="field">
...
<div id="content_research" class="row">
	<div class="field-label">
		...
		<small class="right"><?php  echo __('(The single question you want to get an answer)') ?></small>
	</div>
	<div class="field">
...
<div id="content_opportunity" class="row">
	<div class="field-label">
		<label for="SpecificOpportunity"><?php  echo __('Opportunity') ?></label>
		<small class="right"><?php  echo __('(The most important if future scenario becomes realized)') ?></small>
	</div>
	<div class="field">
...
<div id="content_threat" class="row">
	<div class="field-label">
		<label for="SpecificThreat"><?php  echo __('Threat') ?></label>
		<small class="right"><?php  echo __('(The most important if future scenario becomes realized)') ?></small>
	</div>
	<div class="field">
...
<div id="content_tags" class="row">
	<div class="field-label">
		<label for="TagsTags"><?php  echo __('Keywords, Tags') ?></label>
		<small class="right"><?php  echo __('(Use commas to separate tags)') ?></small>
	</div>
	<div class="field">
	<?php echo $this->Form->input('Content.tags', array('error' => array('wrap' => 'div', 'class' => 'error', true))); ?>
	</div>
	<div class="limit bad"><?php  echo __('required') ?></div>
</div>
<div class="clear"></div>
...
<div id="content_companies" class="row">
	<div class="field-label">
		<label for="CompaniesCompanies"><?php  echo __('Related companies and organizations') ?></label>
		<small class="right"><?php  echo __('(Use commas to separate)') ?></small>
	</div>
	<div class="field">
...
<div id="content_body" class="row">
	<div class="field-label">
		<label for="NodeBody"><?php  echo __('Body text') ?></label>
...
<div id="content_references" class="row">
	<div class="field-label">
		<label for="NodeReferences"><?php  echo __('References') ?></label>
		<small class="right"><?php  echo __('(Youtube video url references are embedded)') ?></small>
	</div>
	<div class="field">
