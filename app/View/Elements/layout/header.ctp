...
<div id="search">
	<div id="search-top">
		<?php if($this->Session->read('Auth.User')): ?>
			...
			Logged in as <?php echo $this->Html->link($this->Session->read('Auth.User.username'), array('controller' => 'Users', 'action' => 'view', $this->Session->read('Auth.User.username') )); ?><span class="grey"> |</span>
                       <?php
                               echo $this->Html->link(
